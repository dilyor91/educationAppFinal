...
/**
 * A DTO for the {@link uz.tashkec.education.domain.Participiant} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ParticipiantDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParticipiantDTO)) {
            return false;
        }

        ParticipiantDTO participiantDTO = (ParticipiantDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, participiantDTO.id);
    }
