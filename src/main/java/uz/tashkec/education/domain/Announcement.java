...
public class Announcement implements Serializable {
    ...
    public Announcement titleUz(String titleUz) {
    ...
    public Announcement titleRu(String titleRu) {
    ...
    public Announcement contentUz(String contentUz) {
    ...
    public Announcement contentRu(String contentRu) {
    ...
    public Announcement status(Boolean status) {
