...
import { EntityArrayResponseType, PeriodService } from '../service/period.service';
...
export class PeriodComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPeriod): number => this.periodService.getPeriodIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.periods = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPeriod[] | null): IPeriod[] {
    return data ?? [];
  }
