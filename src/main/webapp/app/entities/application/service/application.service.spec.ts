...
import { ApplicationService, RestApplication } from './application.service';

const requireRestSample: RestApplication = {
  ...sampleWithRequiredData,
  birthday: sampleWithRequiredData.birthday?.toJSON(),
  certificateGivenDate: sampleWithRequiredData.certificateGivenDate?.toJSON(),
};
