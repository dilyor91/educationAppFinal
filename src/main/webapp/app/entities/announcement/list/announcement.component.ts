...
import { EntityArrayResponseType, AnnouncementService } from '../service/announcement.service';
import { AnnouncementDeleteDialogComponent } from '../delete/announcement-delete-dialog.component';
import { SortService } from 'app/shared/sort/sort.service';

@Component({
  selector: 'jhi-announcement',
...
export class AnnouncementComponent implements OnInit {
  ...
  delete(announcement: IAnnouncement): void {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.announcements = this.refineData(dataFromBody);
  }

  protected refineData(data: IAnnouncement[]): IAnnouncement[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IAnnouncement[] | null): IAnnouncement[] {
    return data ?? [];
  }
